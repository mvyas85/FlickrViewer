...
*
* *
* 4de10bc3f64339c805ff288da9d270d1 = My persnoal API key requested from flickr (Education purpose)
 */
...
public class URLReader extends AsyncTask<String, Void, Void> {
    ...
    String FlickrBaseURL =
            "https://api.flickr.com/services/rest/?method=flickr.photos.getRecent&api_key=4de10bc3f64339c805ff288da9d270d1";
